...
export type TRouteNamePersonal =
    'main-page' |
    'school-history' |
    'school-history-uniforms'

export type  TRouteNamePersonalEdit =
    'school-history' |
    'school-history-uniforms'

export type TRouteNames = TRouteNamePersonal | TRouteNamePersonalEdit
export interface IDefineRouteMeta extends RouteMeta{
    name:TRouteNames
}
export interface IMenuRoute{
    title:string,
    route:IDefineRouteMeta,
    icon?:MaterialIcons
}
export type TLayout = undefined | 'main-layout' | 'empty-layout'
export type TAppCommand = 'locale' | 'theme'
